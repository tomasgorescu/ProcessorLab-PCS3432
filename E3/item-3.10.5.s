.text
.globl main
@ implementação da multiplicação longa com signal a partir da instrução UMULL

main:
 	LDR r0, = 4213213213		@ operando 1
	LDR r1, = 42121321		@ operando 2
preparingRegisters:
