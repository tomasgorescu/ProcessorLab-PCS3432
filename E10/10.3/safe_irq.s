...
do_irq_interrupt: @Rotina de interrupções IRQ
  ...
  CMP r1, #0
  STREQ r0, linhaA @ armazena conteúdo atual de r0 endereço base da pilha
  LDREQ r0, =linhaA @ usa r0 como stack pointer carregando endereço base da pilha

  CMP r1, #1
  STREQ r0, linhaB @ armazena conteúdo atual de r0 endereço base da pilha
  LDREQ r0, =linhaB @ usa r0 como stack pointer carregando endereço base da pilha
