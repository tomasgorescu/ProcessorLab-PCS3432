...
@ ----------------------
@ Prova 2, exercício 2
@ Kernel simples com chaveamento de três processos
@
@
@ Instruções de uso
@ -----------------
...
stackC_init:
  ...
  MRS r0, cpsr @ salva cpsr corrente
  LDR r1, _taskC @ pc da func taskC definida em handler.c
  SUB r2, sp, #0x700 @ valor de sp para taskC
  MOV r4, #55
